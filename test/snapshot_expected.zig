...
pub const client = struct {
    ...
    pub const wp = struct {
        ...
        pub const ImageDescriptionReferenceV1 = opaque {
            pub const generated_version = 1;
            pub const interface = &common.wp.image_description_reference_v1.interface;
            pub inline fn getId(_image_description_reference_v1: *ImageDescriptionReferenceV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_reference_v1)).getId();
            }
            pub inline fn getVersion(_image_description_reference_v1: *ImageDescriptionReferenceV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_reference_v1)).getVersion();
            }
            pub inline fn getUserData(_image_description_reference_v1: *ImageDescriptionReferenceV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_reference_v1)).getUserData();
            }
            pub inline fn setQueue(_image_description_reference_v1: *ImageDescriptionReferenceV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_reference_v1);
                _proxy.setQueue(_queue);
            }
            /// Destroy this object. This has no effect on the referenced image
            /// description.
            pub fn destroy(_image_description_reference_v1: *ImageDescriptionReferenceV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_reference_v1);
                _ = _proxy.marshal(0, null, 0, .{ .destroy = true }, null);
            }
            pub const destroy_since_version = 1;
        ...
        pub const ColorManagerV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.color_manager_v1.interface;
            pub const Error = common.wp.color_manager_v1.Error;
            pub const RenderIntent = common.wp.color_manager_v1.RenderIntent;
            pub const Feature = common.wp.color_manager_v1.Feature;
            pub const Primaries = common.wp.color_manager_v1.Primaries;
            pub const TransferFunction = common.wp.color_manager_v1.TransferFunction;
            pub inline fn getId(_color_manager_v1: *ColorManagerV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_color_manager_v1)).getId();
            }
            pub inline fn getVersion(_color_manager_v1: *ColorManagerV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_color_manager_v1)).getVersion();
            }
            pub inline fn getUserData(_color_manager_v1: *ColorManagerV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_color_manager_v1)).getUserData();
            }
            pub inline fn setQueue(_color_manager_v1: *ColorManagerV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                _proxy.setQueue(_queue);
            }
            pub const Event = union(enum) {
                pub const supported_intent_since_version = 1;
                pub const supported_feature_since_version = 1;
                pub const supported_tf_named_since_version = 1;
                pub const supported_primaries_named_since_version = 1;
                pub const done_since_version = 1;
                ...
                /// bound version of the interface.
                supported_primaries_named: struct {
                    primaries: Primaries,
                },
            ...
            pub inline fn setListener(
                _color_manager_v1: *ColorManagerV1,
                comptime T: type,
                _listener: *const fn (color_manager_v1: *ColorManagerV1, event: Event, data: T) void,
                _data: T,
            ) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                const _mut_data: ?*anyopaque = @ptrFromInt(@intFromPtr(_data));
                _proxy.addDispatcher(common.Dispatcher(ColorManagerV1, T).dispatcher, _listener, _mut_data);
            }
            /// Destroy the wp_color_manager_v1 object. This does not affect any other
            /// objects in any way.
            pub fn destroy(_color_manager_v1: *ColorManagerV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                _ = _proxy.marshal(0, null, 0, .{ .destroy = true }, null);
            }
            pub const destroy_since_version = 1;
            ...
            pub fn getOutput(_color_manager_v1: *ColorManagerV1, _output: *client.wl.Output) !*client.wp.ColorManagementOutputV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                    .{ .o = @ptrCast(_output) },
                };
                const _ret = _proxy.marshal(1, client.wp.ColorManagementOutputV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const get_output_since_version = 1;
            ...
            pub fn getSurface(_color_manager_v1: *ColorManagerV1, _surface: *client.wl.Surface) !*client.wp.ColorManagementSurfaceV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                    .{ .o = @ptrCast(_surface) },
                };
                const _ret = _proxy.marshal(2, client.wp.ColorManagementSurfaceV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const get_surface_since_version = 1;
            ...
            /// details.
            pub fn getSurfaceFeedback(_color_manager_v1: *ColorManagerV1, _surface: *client.wl.Surface) !*client.wp.ColorManagementSurfaceFeedbackV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                    .{ .o = @ptrCast(_surface) },
                };
                const _ret = _proxy.marshal(3, client.wp.ColorManagementSurfaceFeedbackV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const get_surface_feedback_since_version = 1;
            ...
            pub fn createIccCreator(_color_manager_v1: *ColorManagerV1) !*client.wp.ImageDescriptionCreatorIccV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                };
                const _ret = _proxy.marshal(4, client.wp.ImageDescriptionCreatorIccV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const create_icc_creator_since_version = 1;
            ...
            /// Otherwise this request raises the protocol error unsupported_feature.
            pub fn createParametricCreator(_color_manager_v1: *ColorManagerV1) !*client.wp.ImageDescriptionCreatorParamsV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                };
                const _ret = _proxy.marshal(5, client.wp.ImageDescriptionCreatorParamsV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const create_parametric_creator_since_version = 1;
            ...
            pub fn createWindowsScrgb(_color_manager_v1: *ColorManagerV1) !*client.wp.ImageDescriptionV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                };
                const _ret = _proxy.marshal(6, client.wp.ImageDescriptionV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const create_windows_scrgb_since_version = 1;
            ...
            pub fn getImageDescription(_color_manager_v1: *ColorManagerV1, _reference: *client.wp.ImageDescriptionReferenceV1) !*client.wp.ImageDescriptionV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                    .{ .o = @ptrCast(_reference) },
                };
                const _ret = _proxy.marshal(7, client.wp.ImageDescriptionV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const get_image_description_since_version = 2;
        };
        ...
        pub const ColorManagementOutputV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.color_management_output_v1.interface;
            pub inline fn getId(_color_management_output_v1: *ColorManagementOutputV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_color_management_output_v1)).getId();
            }
            pub inline fn getVersion(_color_management_output_v1: *ColorManagementOutputV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_color_management_output_v1)).getVersion();
            }
            pub inline fn getUserData(_color_management_output_v1: *ColorManagementOutputV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_color_management_output_v1)).getUserData();
            }
            pub inline fn setQueue(_color_management_output_v1: *ColorManagementOutputV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_output_v1);
                _proxy.setQueue(_queue);
            }
            pub const Event = union(enum) {
                pub const image_description_changed_since_version = 1;
                ...
                /// immutable.
                image_description_changed: void,
            };
            pub inline fn setListener(
                _color_management_output_v1: *ColorManagementOutputV1,
                comptime T: type,
                _listener: *const fn (color_management_output_v1: *ColorManagementOutputV1, event: Event, data: T) void,
                _data: T,
            ) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_output_v1);
                const _mut_data: ?*anyopaque = @ptrFromInt(@intFromPtr(_data));
                _proxy.addDispatcher(common.Dispatcher(ColorManagementOutputV1, T).dispatcher, _listener, _mut_data);
            }
            /// Destroy the color wp_color_management_output_v1 object. This does not
            /// affect any remaining protocol objects.
            pub fn destroy(_color_management_output_v1: *ColorManagementOutputV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_output_v1);
                _ = _proxy.marshal(0, null, 0, .{ .destroy = true }, null);
            }
            pub const destroy_since_version = 1;
            ...
            pub fn getImageDescription(_color_management_output_v1: *ColorManagementOutputV1) !*client.wp.ImageDescriptionV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_output_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                };
                const _ret = _proxy.marshal(1, client.wp.ImageDescriptionV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const get_image_description_since_version = 1;
        };
        ...
        pub const ImageDescriptionV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.image_description_v1.interface;
            pub const Error = common.wp.image_description_v1.Error;
            pub const Cause = common.wp.image_description_v1.Cause;
            pub inline fn getId(_image_description_v1: *ImageDescriptionV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_v1)).getId();
            }
            pub inline fn getVersion(_image_description_v1: *ImageDescriptionV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_v1)).getVersion();
            }
            pub inline fn getUserData(_image_description_v1: *ImageDescriptionV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_v1)).getUserData();
            }
            pub inline fn setQueue(_image_description_v1: *ImageDescriptionV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_v1);
                _proxy.setQueue(_queue);
            }
            pub const Event = union(enum) {
                pub const failed_since_version = 1;
                pub const ready_since_version = 1;
                pub const ready2_since_version = 2;
            ...
            pub inline fn setListener(
                _image_description_v1: *ImageDescriptionV1,
                comptime T: type,
                _listener: *const fn (image_description_v1: *ImageDescriptionV1, event: Event, data: T) void,
                _data: T,
            ) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_v1);
                const _mut_data: ?*anyopaque = @ptrFromInt(@intFromPtr(_data));
                _proxy.addDispatcher(common.Dispatcher(ImageDescriptionV1, T).dispatcher, _listener, _mut_data);
            }
            ...
            pub fn destroy(_image_description_v1: *ImageDescriptionV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_v1);
                _ = _proxy.marshal(0, null, 0, .{ .destroy = true }, null);
            }
            pub const destroy_since_version = 1;
            ...
            pub fn getInformation(_image_description_v1: *ImageDescriptionV1) !*client.wp.ImageDescriptionInfoV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                };
                const _ret = _proxy.marshal(1, client.wp.ImageDescriptionInfoV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const get_information_since_version = 1;
        };
        ...
        pub const ImageDescriptionInfoV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.image_description_info_v1.interface;
            pub inline fn getId(_image_description_info_v1: *ImageDescriptionInfoV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_info_v1)).getId();
            }
            pub inline fn getVersion(_image_description_info_v1: *ImageDescriptionInfoV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_info_v1)).getVersion();
            }
            pub inline fn getUserData(_image_description_info_v1: *ImageDescriptionInfoV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_info_v1)).getUserData();
            }
            pub inline fn setQueue(_image_description_info_v1: *ImageDescriptionInfoV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_info_v1);
                _proxy.setQueue(_queue);
            }
            pub const Event = union(enum) {
                pub const done_since_version = 1;
                pub const icc_file_since_version = 1;
                pub const primaries_since_version = 1;
                pub const primaries_named_since_version = 1;
                pub const tf_power_since_version = 1;
                pub const tf_named_since_version = 1;
                pub const luminances_since_version = 1;
                pub const target_primaries_since_version = 1;
                pub const target_luminance_since_version = 1;
                pub const target_max_cll_since_version = 1;
                pub const target_max_fall_since_version = 1;
                ...
                primaries_named: struct {
                    primaries: common.wp.color_manager_v1.Primaries,
                },
                ...
                /// named function.
                tf_named: struct {
                    tf: common.wp.color_manager_v1.TransferFunction,
                },
                ...
                /// This luminance is only theoretical and may not correspond to the
                /// luminance of light emitted on an actual display.
                target_max_fall: struct {
                    max_fall: u32,
                },
            };
            pub inline fn setListener(
                _image_description_info_v1: *ImageDescriptionInfoV1,
                comptime T: type,
                _listener: *const fn (image_description_info_v1: *ImageDescriptionInfoV1, event: Event, data: T) void,
                _data: T,
            ) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_info_v1);
                const _mut_data: ?*anyopaque = @ptrFromInt(@intFromPtr(_data));
                _proxy.addDispatcher(common.Dispatcher(ImageDescriptionInfoV1, T).dispatcher, _listener, _mut_data);
            }
            pub inline fn destroy(_image_description_info_v1: *ImageDescriptionInfoV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_info_v1);
                _proxy.destroy();
            }
        };
        ...
        pub const ColorManagementSurfaceV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.color_management_surface_v1.interface;
            pub const Error = common.wp.color_management_surface_v1.Error;
            pub inline fn getId(_color_management_surface_v1: *ColorManagementSurfaceV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_color_management_surface_v1)).getId();
            }
            pub inline fn getVersion(_color_management_surface_v1: *ColorManagementSurfaceV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_color_management_surface_v1)).getVersion();
            }
            pub inline fn getUserData(_color_management_surface_v1: *ColorManagementSurfaceV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_color_management_surface_v1)).getUserData();
            }
            pub inline fn setQueue(_color_management_surface_v1: *ColorManagementSurfaceV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_surface_v1);
                _proxy.setQueue(_queue);
            }
            /// Destroy the wp_color_management_surface_v1 object and do the same as
            /// unset_image_description.
            pub fn destroy(_color_management_surface_v1: *ColorManagementSurfaceV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_surface_v1);
                _ = _proxy.marshal(0, null, 0, .{ .destroy = true }, null);
            }
            pub const destroy_since_version = 1;
            ...
            pub fn setImageDescription(_color_management_surface_v1: *ColorManagementSurfaceV1, _image_description: *client.wp.ImageDescriptionV1, _render_intent: common.wp.color_manager_v1.RenderIntent) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_surface_v1);
                var _args = [_]common.Argument{
            ...
            pub const set_image_description_since_version = 1;
            ...
            /// wl_surface.commit.
            pub fn unsetImageDescription(_color_management_surface_v1: *ColorManagementSurfaceV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_surface_v1);
                _ = _proxy.marshal(2, null, 0, .{}, null);
            }
            pub const unset_image_description_since_version = 1;
        };
        ...
        pub const ColorManagementSurfaceFeedbackV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.color_management_surface_feedback_v1.interface;
            pub const Error = common.wp.color_management_surface_feedback_v1.Error;
            pub inline fn getId(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_color_management_surface_feedback_v1)).getId();
            }
            pub inline fn getVersion(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_color_management_surface_feedback_v1)).getVersion();
            }
            pub inline fn getUserData(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_color_management_surface_feedback_v1)).getUserData();
            }
            pub inline fn setQueue(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_surface_feedback_v1);
                _proxy.setQueue(_queue);
            }
            pub const Event = union(enum) {
                pub const preferred_changed_since_version = 1;
                pub const preferred_changed2_since_version = 2;
                ...
                preferred_changed2: struct {
                    identity_hi: u32,
                    identity_lo: u32,
                },
            };
            pub inline fn setListener(
                _color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1,
                comptime T: type,
                _listener: *const fn (color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1, event: Event, data: T) void,
                _data: T,
            ) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_surface_feedback_v1);
                const _mut_data: ?*anyopaque = @ptrFromInt(@intFromPtr(_data));
                _proxy.addDispatcher(common.Dispatcher(ColorManagementSurfaceFeedbackV1, T).dispatcher, _listener, _mut_data);
            }
            /// Destroy the wp_color_management_surface_feedback_v1 object.
            pub fn destroy(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_surface_feedback_v1);
                _ = _proxy.marshal(0, null, 0, .{ .destroy = true }, null);
            }
            pub const destroy_since_version = 1;
            ...
            /// wp_image_description_v1.failed event with the low_version cause,
            /// otherwise the object shall immediately deliver the ready event.
            pub fn getPreferred(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) !*client.wp.ImageDescriptionV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_surface_feedback_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                };
            ...
            pub const get_preferred_since_version = 1;
            ...
            pub fn getPreferredParametric(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) !*client.wp.ImageDescriptionV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_color_management_surface_feedback_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                };
                const _ret = _proxy.marshal(2, client.wp.ImageDescriptionV1.interface, _proxy.getVersion(), .{}, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            pub const get_preferred_parametric_since_version = 1;
        };
        ...
        pub const ImageDescriptionCreatorIccV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.image_description_creator_icc_v1.interface;
            pub const Error = common.wp.image_description_creator_icc_v1.Error;
            pub inline fn getId(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_creator_icc_v1)).getId();
            }
            pub inline fn getVersion(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_creator_icc_v1)).getVersion();
            }
            pub inline fn getUserData(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_creator_icc_v1)).getUserData();
            }
            pub inline fn setQueue(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_icc_v1);
                _proxy.setQueue(_queue);
            }
            ...
            /// The resulting image description object does not allow get_information
            /// request.
            pub fn create(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) !*client.wp.ImageDescriptionV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_icc_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                };
                const _ret = _proxy.marshal(0, client.wp.ImageDescriptionV1.interface, _proxy.getVersion(), .{ .destroy = true }, &_args);
                return @ptrCast(_ret orelse return error.OutOfMemory);
            }
            ...
            pub fn setIccFile(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1, _icc_profile: i32, _offset: u32, _length: u32) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_icc_v1);
                var _args = [_]common.Argument{
                    .{ .h = _icc_profile },
                    .{ .u = _offset },
            ...
            pub const set_icc_file_since_version = 1;
            pub inline fn destroy(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_icc_v1);
                _proxy.destroy();
            }
        };
        ...
        pub const ImageDescriptionCreatorParamsV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.image_description_creator_params_v1.interface;
            pub const Error = common.wp.image_description_creator_params_v1.Error;
            pub inline fn getId(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_creator_params_v1)).getId();
            }
            pub inline fn getVersion(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_creator_params_v1)).getVersion();
            }
            pub inline fn getUserData(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_image_description_creator_params_v1)).getUserData();
            }
            pub inline fn setQueue(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _queue: *client.wl.EventQueue) void {
            ...
            /// The resulting image description object does not allow get_information
            /// request.
            pub fn create(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) !*client.wp.ImageDescriptionV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                };
            ...
            pub fn setTfNamed(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _tf: common.wp.color_manager_v1.TransferFunction) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
            ...
            pub const set_tf_named_since_version = 1;
            ...
            pub fn setTfPower(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _eexp: u32) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
                    .{ .u = _eexp },
                };
            ...
            pub const set_tf_power_since_version = 1;
            ...
            /// already_set is raised.
            pub fn setPrimariesNamed(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _primaries: common.wp.color_manager_v1.Primaries) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
            ...
            pub const set_primaries_named_since_version = 1;
            ...
            /// the protocol error unsupported_feature.
            pub fn setPrimaries(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _r_x: i32, _r_y: i32, _g_x: i32, _g_y: i32, _b_x: i32, _b_y: i32, _w_x: i32, _w_y: i32) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
                    .{ .i = _r_x },
                    .{ .i = _r_y },
            ...
            pub const set_primaries_since_version = 1;
            ...
            pub fn setLuminances(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _min_lum: u32, _max_lum: u32, _reference_lum: u32) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
                    .{ .u = _min_lum },
                    .{ .u = _max_lum },
            ...
            pub const set_luminances_since_version = 1;
            ...
            pub fn setMasteringDisplayPrimaries(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _r_x: i32, _r_y: i32, _g_x: i32, _g_y: i32, _b_x: i32, _b_y: i32, _w_x: i32, _w_y: i32) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
                    .{ .i = _r_x },
                    .{ .i = _r_y },
            ...
            pub const set_mastering_display_primaries_since_version = 1;
            ...
            /// Compositors are recommended to detect this case and fail the image
            /// description gracefully, but it may as well result in color artifacts.
            pub fn setMasteringLuminance(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _min_lum: u32, _max_lum: u32) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
                    .{ .u = _min_lum },
                    .{ .u = _max_lum },
            ...
            pub const set_mastering_luminance_since_version = 1;

            /// Sets the maximum content light level (max_cll) as defined by CTA-861-H.
            ///
            /// max_cll is undefined by default.
            pub fn setMaxCll(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _max_cll: u32) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
                    .{ .u = _max_cll },
                };
            ...
            pub const set_max_cll_since_version = 1;

            /// Sets the maximum frame-average light level (max_fall) as defined by
            /// CTA-861-H.
            ///
            /// max_fall is undefined by default.
            pub fn setMaxFall(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, _max_fall: u32) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                var _args = [_]common.Argument{
                    .{ .u = _max_fall },
                };
            ...
            pub const set_max_fall_since_version = 1;
            pub inline fn destroy(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_image_description_creator_params_v1);
                _proxy.destroy();
            }
        };
...
pub const server = struct {
    ...
    pub const wp = struct {
        ...
        pub const ImageDescriptionReferenceV1 = opaque {
            pub const generated_version = 1;
            pub const interface = &common.wp.image_description_reference_v1.interface;
            pub inline fn create(_client: *server.wl.Client, _version: u32, _id: u32) error{ResourceCreateFailed}!*ImageDescriptionReferenceV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ImageDescriptionReferenceV1, _version, _id));
            }
            pub inline fn destroy(_image_description_reference_v1: *ImageDescriptionReferenceV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_reference_v1)).destroy();
            }
            pub inline fn fromLink(_link: *server.wl.list.Link) *ImageDescriptionReferenceV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub inline fn getLink(_image_description_reference_v1: *ImageDescriptionReferenceV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_image_description_reference_v1)).getLink();
            }
            pub inline fn getClient(_image_description_reference_v1: *ImageDescriptionReferenceV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_image_description_reference_v1)).getClient();
            }
            pub inline fn getId(_image_description_reference_v1: *ImageDescriptionReferenceV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_reference_v1)).getId();
            }
            pub inline fn getVersion(_image_description_reference_v1: *ImageDescriptionReferenceV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_reference_v1)).getVersion();
            }
            pub inline fn postNoMemory(_image_description_reference_v1: *ImageDescriptionReferenceV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_reference_v1)).postNoMemory();
            }
            pub inline fn getUserData(_image_description_reference_v1: *ImageDescriptionReferenceV1) ?*anyopaque {
                return @as(*server.wl.Resource, @ptrCast(_image_description_reference_v1)).getUserData();
            }
            pub const Request = union(enum) {
                pub const destroy_since_version = 1;
            ...
            pub inline fn setHandler(
                _image_description_reference_v1: *ImageDescriptionReferenceV1,
                comptime T: type,
                handle_request: *const fn (_image_description_reference_v1: *ImageDescriptionReferenceV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_image_description_reference_v1: *ImageDescriptionReferenceV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_reference_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ImageDescriptionReferenceV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.c) void {
                            _handler(
                                @as(*ImageDescriptionReferenceV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            );
                        }
                    }._wrapper else null,
        ...
        pub const ColorManagerV1 = opaque {
            ...
            pub const Primaries = common.wp.color_manager_v1.Primaries;
            pub const TransferFunction = common.wp.color_manager_v1.TransferFunction;
            pub inline fn create(_client: *server.wl.Client, _version: u32, _id: u32) error{ResourceCreateFailed}!*ColorManagerV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ColorManagerV1, _version, _id));
            }
            pub inline fn destroy(_color_manager_v1: *ColorManagerV1) void {
                return @as(*server.wl.Resource, @ptrCast(_color_manager_v1)).destroy();
            }
            pub inline fn fromLink(_link: *server.wl.list.Link) *ColorManagerV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub inline fn getLink(_color_manager_v1: *ColorManagerV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_color_manager_v1)).getLink();
            }
            pub inline fn getClient(_color_manager_v1: *ColorManagerV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_color_manager_v1)).getClient();
            }
            pub inline fn getId(_color_manager_v1: *ColorManagerV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_color_manager_v1)).getId();
            }
            pub inline fn getVersion(_color_manager_v1: *ColorManagerV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_color_manager_v1)).getVersion();
            }
            pub inline fn postNoMemory(_color_manager_v1: *ColorManagerV1) void {
                return @as(*server.wl.Resource, @ptrCast(_color_manager_v1)).postNoMemory();
            }
            pub inline fn getUserData(_color_manager_v1: *ColorManagerV1) ?*anyopaque {
            ...
            pub const Request = union(enum) {
                ...
                /// wp_color_manager_v1.feature.parametric.
                /// Otherwise this request raises the protocol error unsupported_feature.
                create_parametric_creator: struct {
                    obj: u32,
                },
                ...
                /// The get_information request can be used if and only if the request that
                /// creates the reference allows it.
                get_image_description: struct {
                    image_description: u32,
                    reference: *server.wp.ImageDescriptionReferenceV1,
                },
            };
            pub inline fn setHandler(
                _color_manager_v1: *ColorManagerV1,
                comptime T: type,
                handle_request: *const fn (_color_manager_v1: *ColorManagerV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_color_manager_v1: *ColorManagerV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_manager_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ColorManagerV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.c) void {
                            _handler(
                                @as(*ColorManagerV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            );
                        }
                    }._wrapper else null,
            ...
            /// A compositor must not advertise intents that are deprecated in the
            /// bound version of the interface.
            pub fn sendSupportedIntent(_color_manager_v1: *ColorManagerV1, _render_intent: RenderIntent) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
            ...
            /// A compositor must not advertise features that are deprecated in the
            /// bound version of the interface.
            pub fn sendSupportedFeature(_color_manager_v1: *ColorManagerV1, _feature: Feature) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
            ...
            /// A compositor must not advertise transfer functions that are deprecated
            /// in the bound version of the interface.
            pub fn sendSupportedTfNamed(_color_manager_v1: *ColorManagerV1, _tf: TransferFunction) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
            ...
            /// A compositor must not advertise names that are deprecated in the
            /// bound version of the interface.
            pub fn sendSupportedPrimariesNamed(_color_manager_v1: *ColorManagerV1, _primaries: Primaries) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_manager_v1);
                var _args = [_]common.Argument{
            ...
            /// This event is sent when all supported rendering intents, features,
            /// transfer functions and named primaries have been sent.
            pub fn sendDone(_color_manager_v1: *ColorManagerV1) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_manager_v1);
                _resource.postEvent(4, null);
            }
            pub const done_since_version = 1;
        ...
        pub const ColorManagementOutputV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.color_management_output_v1.interface;
            pub inline fn create(_client: *server.wl.Client, _version: u32, _id: u32) error{ResourceCreateFailed}!*ColorManagementOutputV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ColorManagementOutputV1, _version, _id));
            }
            pub inline fn destroy(_color_management_output_v1: *ColorManagementOutputV1) void {
                return @as(*server.wl.Resource, @ptrCast(_color_management_output_v1)).destroy();
            }
            pub inline fn fromLink(_link: *server.wl.list.Link) *ColorManagementOutputV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub inline fn getLink(_color_management_output_v1: *ColorManagementOutputV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_color_management_output_v1)).getLink();
            }
            pub inline fn getClient(_color_management_output_v1: *ColorManagementOutputV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_color_management_output_v1)).getClient();
            }
            pub inline fn getId(_color_management_output_v1: *ColorManagementOutputV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_color_management_output_v1)).getId();
            }
            pub inline fn getVersion(_color_management_output_v1: *ColorManagementOutputV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_color_management_output_v1)).getVersion();
            }
            pub inline fn postNoMemory(_color_management_output_v1: *ColorManagementOutputV1) void {
                return @as(*server.wl.Resource, @ptrCast(_color_management_output_v1)).postNoMemory();
            }
            pub inline fn getUserData(_color_management_output_v1: *ColorManagementOutputV1) ?*anyopaque {
                return @as(*server.wl.Resource, @ptrCast(_color_management_output_v1)).getUserData();
            }
            pub const Request = union(enum) {
                pub const destroy_since_version = 1;
                pub const get_image_description_since_version = 1;
            ...
            pub inline fn setHandler(
                _color_management_output_v1: *ColorManagementOutputV1,
                comptime T: type,
                handle_request: *const fn (_color_management_output_v1: *ColorManagementOutputV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_color_management_output_v1: *ColorManagementOutputV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_management_output_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ColorManagementOutputV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.c) void {
                            _handler(
                                @as(*ColorManagementOutputV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            );
                        }
                    }._wrapper else null,
            ...
            /// get_image_description again, because image description objects are
            /// immutable.
            pub fn sendImageDescriptionChanged(_color_management_output_v1: *ColorManagementOutputV1) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_management_output_v1);
                _resource.postEvent(0, null);
            }
            pub const image_description_changed_since_version = 1;
        ...
        pub const ImageDescriptionV1 = opaque {
            ...
            pub const Error = common.wp.image_description_v1.Error;
            pub const Cause = common.wp.image_description_v1.Cause;
            pub inline fn create(_client: *server.wl.Client, _version: u32, _id: u32) error{ResourceCreateFailed}!*ImageDescriptionV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ImageDescriptionV1, _version, _id));
            }
            pub inline fn destroy(_image_description_v1: *ImageDescriptionV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_v1)).destroy();
            }
            pub inline fn fromLink(_link: *server.wl.list.Link) *ImageDescriptionV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub inline fn getLink(_image_description_v1: *ImageDescriptionV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_image_description_v1)).getLink();
            }
            pub inline fn getClient(_image_description_v1: *ImageDescriptionV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_image_description_v1)).getClient();
            }
            pub inline fn getId(_image_description_v1: *ImageDescriptionV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_v1)).getId();
            }
            pub inline fn getVersion(_image_description_v1: *ImageDescriptionV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_v1)).getVersion();
            }
            pub inline fn postNoMemory(_image_description_v1: *ImageDescriptionV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_v1)).postNoMemory();
            }
            pub inline fn getUserData(_image_description_v1: *ImageDescriptionV1) ?*anyopaque {
            ...
            pub inline fn setHandler(
                _image_description_v1: *ImageDescriptionV1,
                comptime T: type,
                handle_request: *const fn (_image_description_v1: *ImageDescriptionV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_image_description_v1: *ImageDescriptionV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ImageDescriptionV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.c) void {
                            _handler(
                                @as(*ImageDescriptionV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            );
                        }
                    }._wrapper else null,
            ...
            /// Once this event has been sent, the wp_image_description_v1 object will
            /// never become ready and it can only be destroyed.
            pub fn sendFailed(_image_description_v1: *ImageDescriptionV1, _cause: Cause, _msg: [*:0]const u8) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_v1);
                var _args = [_]common.Argument{
            ...
            /// destroyed, the id number may be recycled for a different image
            /// description record.
            pub fn sendReady(_image_description_v1: *ImageDescriptionV1, _identity: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_v1);
                var _args = [_]common.Argument{
                    .{ .u = _identity },
                };
            ...
            /// and avoid get_information request if they already have the image
            /// description information.
            pub fn sendReady2(_image_description_v1: *ImageDescriptionV1, _identity_hi: u32, _identity_lo: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_v1);
                var _args = [_]common.Argument{
                    .{ .u = _identity_hi },
                    .{ .u = _identity_lo },
        ...
        pub const ImageDescriptionInfoV1 = opaque {
            pub const generated_version = 2;
            pub const interface = &common.wp.image_description_info_v1.interface;
            pub inline fn create(_client: *server.wl.Client, _version: u32, _id: u32) error{ResourceCreateFailed}!*ImageDescriptionInfoV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ImageDescriptionInfoV1, _version, _id));
            }
            pub inline fn destroy(_image_description_info_v1: *ImageDescriptionInfoV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_info_v1)).destroy();
            }
            pub inline fn fromLink(_link: *server.wl.list.Link) *ImageDescriptionInfoV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub inline fn getLink(_image_description_info_v1: *ImageDescriptionInfoV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_image_description_info_v1)).getLink();
            }
            pub inline fn getClient(_image_description_info_v1: *ImageDescriptionInfoV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_image_description_info_v1)).getClient();
            }
            pub inline fn getId(_image_description_info_v1: *ImageDescriptionInfoV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_info_v1)).getId();
            }
            pub inline fn getVersion(_image_description_info_v1: *ImageDescriptionInfoV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_info_v1)).getVersion();
            }
            pub inline fn postNoMemory(_image_description_info_v1: *ImageDescriptionInfoV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_info_v1)).postNoMemory();
            }
            pub inline fn getUserData(_image_description_info_v1: *ImageDescriptionInfoV1) ?*anyopaque {
                return @as(*server.wl.Resource, @ptrCast(_image_description_info_v1)).getUserData();
            }
            pub inline fn setHandler(
                _image_description_info_v1: *ImageDescriptionInfoV1,
                comptime T: type,
                comptime handle_destroy: ?fn (_image_description_info_v1: *ImageDescriptionInfoV1, data: T) void,
                _data: T,
            ) void {
                ...
                _resource.setDispatcher(
                    ...
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.c) void {
                            _handler(
                                @as(*ImageDescriptionInfoV1, @ptrCast(__resource)),
                                @as(?*anyopaque, @ptrFromInt(@intFromPtr(__resource.getUserData()))),
                            );
                        }
                    }._wrapper else null,
            ...
            /// Signals the end of information events and destroys the object.
            pub fn destroySendDone(_image_description_info_v1: *ImageDescriptionInfoV1) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                _resource.postEvent(0, null);
                _resource.destroy();
            }
            ...
            /// compositor. There is no provision for a client to ask for a specific
            /// kind of a profile.
            pub fn sendIccFile(_image_description_info_v1: *ImageDescriptionInfoV1, _icc: i32, _icc_size: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .h = _icc },
                    .{ .u = _icc_size },
            ...
            /// Each coordinate value is multiplied by 1 million to get the argument
            /// value to carry precision of 6 decimals.
            pub fn sendPrimaries(_image_description_info_v1: *ImageDescriptionInfoV1, _r_x: i32, _r_y: i32, _g_x: i32, _g_y: i32, _b_x: i32, _b_y: i32, _w_x: i32, _w_y: i32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .i = _r_x },
                    .{ .i = _r_y },
            ...
            /// Delivers the primary color volume primaries and white point using an
            /// explicitly enumerated named set.
            pub fn sendPrimariesNamed(_image_description_info_v1: *ImageDescriptionInfoV1, _primaries: common.wp.color_manager_v1.Primaries) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .u = switch (@typeInfo(common.wp.color_manager_v1.Primaries)) {
                        .@"enum" => @as(u32, @intCast(@intFromEnum(_primaries))),
            ...
            /// The curve exponent has been multiplied by 10000 to get the argument eexp
            /// value to carry the precision of 4 decimals.
            pub fn sendTfPower(_image_description_info_v1: *ImageDescriptionInfoV1, _eexp: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .u = _eexp },
                };
            ...
            /// Delivers the transfer characteristic using an explicitly enumerated
            /// named function.
            pub fn sendTfNamed(_image_description_info_v1: *ImageDescriptionInfoV1, _tf: common.wp.color_manager_v1.TransferFunction) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .u = switch (@typeInfo(common.wp.color_manager_v1.TransferFunction)) {
                        .@"enum" => @as(u32, @intCast(@intFromEnum(_tf))),
            ...
            /// 'min_lum' value and carries precision of 4 decimals. The maximum
            /// luminance and reference white luminance values are unscaled.
            pub fn sendLuminances(_image_description_info_v1: *ImageDescriptionInfoV1, _min_lum: u32, _max_lum: u32, _reference_lum: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .u = _min_lum },
                    .{ .u = _max_lum },
            ...
            /// Each coordinate value is multiplied by 1 million to get the argument
            /// value to carry precision of 6 decimals.
            pub fn sendTargetPrimaries(_image_description_info_v1: *ImageDescriptionInfoV1, _r_x: i32, _r_y: i32, _g_x: i32, _g_y: i32, _b_x: i32, _b_y: i32, _w_x: i32, _w_y: i32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .i = _r_x },
                    .{ .i = _r_y },
            ...
            /// Min L value is multiplied by 10000 to get the argument min_lum value and
            /// carry precision of 4 decimals. Max L value is unscaled for max_lum.
            pub fn sendTargetLuminance(_image_description_info_v1: *ImageDescriptionInfoV1, _min_lum: u32, _max_lum: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .u = _min_lum },
                    .{ .u = _max_lum },
            ...
            /// This luminance is only theoretical and may not correspond to the
            /// luminance of light emitted on an actual display.
            pub fn sendTargetMaxCll(_image_description_info_v1: *ImageDescriptionInfoV1, _max_cll: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .u = _max_cll },
                };
            ...
            /// This luminance is only theoretical and may not correspond to the
            /// luminance of light emitted on an actual display.
            pub fn sendTargetMaxFall(_image_description_info_v1: *ImageDescriptionInfoV1, _max_fall: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_info_v1);
                var _args = [_]common.Argument{
                    .{ .u = _max_fall },
                };
        ...
        pub const ColorManagementSurfaceV1 = opaque {
            ...
            pub const interface = &common.wp.color_management_surface_v1.interface;
            pub const Error = common.wp.color_management_surface_v1.Error;
            pub inline fn create(_client: *server.wl.Client, _version: u32, _id: u32) error{ResourceCreateFailed}!*ColorManagementSurfaceV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ColorManagementSurfaceV1, _version, _id));
            }
            pub inline fn destroy(_color_management_surface_v1: *ColorManagementSurfaceV1) void {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_v1)).destroy();
            }
            pub inline fn fromLink(_link: *server.wl.list.Link) *ColorManagementSurfaceV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub inline fn getLink(_color_management_surface_v1: *ColorManagementSurfaceV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_v1)).getLink();
            }
            pub inline fn getClient(_color_management_surface_v1: *ColorManagementSurfaceV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_v1)).getClient();
            }
            pub inline fn getId(_color_management_surface_v1: *ColorManagementSurfaceV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_v1)).getId();
            }
            pub inline fn getVersion(_color_management_surface_v1: *ColorManagementSurfaceV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_v1)).getVersion();
            }
            pub inline fn postNoMemory(_color_management_surface_v1: *ColorManagementSurfaceV1) void {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_v1)).postNoMemory();
            }
            pub inline fn getUserData(_color_management_surface_v1: *ColorManagementSurfaceV1) ?*anyopaque {
            ...
            pub const Request = union(enum) {
                ...
                /// the image description can be immediately destroyed without affecting
                /// the pending state of the surface.
                set_image_description: struct {
                    image_description: *server.wp.ImageDescriptionV1,
                    render_intent: common.wp.color_manager_v1.RenderIntent,
                },
                ...
                /// an image description. This is double-buffered state, see
                /// wl_surface.commit.
                unset_image_description: void,
            };
            pub inline fn setHandler(
                _color_management_surface_v1: *ColorManagementSurfaceV1,
                comptime T: type,
                handle_request: *const fn (_color_management_surface_v1: *ColorManagementSurfaceV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_color_management_surface_v1: *ColorManagementSurfaceV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_management_surface_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ColorManagementSurfaceV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.c) void {
                            _handler(
                                @as(*ColorManagementSurfaceV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            );
                        }
                    }._wrapper else null,
        ...
        pub const ColorManagementSurfaceFeedbackV1 = opaque {
            ...
            pub const interface = &common.wp.color_management_surface_feedback_v1.interface;
            pub const Error = common.wp.color_management_surface_feedback_v1.Error;
            pub inline fn create(_client: *server.wl.Client, _version: u32, _id: u32) error{ResourceCreateFailed}!*ColorManagementSurfaceFeedbackV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ColorManagementSurfaceFeedbackV1, _version, _id));
            }
            pub inline fn destroy(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) void {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_feedback_v1)).destroy();
            }
            pub inline fn fromLink(_link: *server.wl.list.Link) *ColorManagementSurfaceFeedbackV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub inline fn getLink(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_feedback_v1)).getLink();
            }
            pub inline fn getClient(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_feedback_v1)).getClient();
            }
            pub inline fn getId(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_feedback_v1)).getId();
            }
            pub inline fn getVersion(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_feedback_v1)).getVersion();
            }
            pub inline fn postNoMemory(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) void {
                return @as(*server.wl.Resource, @ptrCast(_color_management_surface_feedback_v1)).postNoMemory();
            }
            pub inline fn getUserData(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1) ?*anyopaque {
            ...
            pub const Request = union(enum) {
                ...
                /// If the compositor doesn't support parametric image descriptions, the
                /// unsupported_feature error is emitted.
                get_preferred_parametric: struct {
                    image_description: u32,
                },
            };
            pub inline fn setHandler(
                _color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1,
                comptime T: type,
                handle_request: *const fn (_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_management_surface_feedback_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ColorManagementSurfaceFeedbackV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.c) void {
                            _handler(
                                @as(*ColorManagementSurfaceFeedbackV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            );
                        }
                    }._wrapper else null,
            ...
            /// Starting from interface version 2, 'preferred_changed2' is sent instead
            /// of this event. See the 'preferred_changed2' event for the definition.
            pub fn sendPreferredChanged(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1, _identity: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_management_surface_feedback_v1);
                var _args = [_]common.Argument{
                    .{ .u = _identity },
                };
            ...
            /// image description. Therefore clients that can, should render according
            /// to the preferred image description
            pub fn sendPreferredChanged2(_color_management_surface_feedback_v1: *ColorManagementSurfaceFeedbackV1, _identity_hi: u32, _identity_lo: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_color_management_surface_feedback_v1);
                var _args = [_]common.Argument{
                    .{ .u = _identity_hi },
                    .{ .u = _identity_lo },
        ...
        pub const ImageDescriptionCreatorIccV1 = opaque {
            ...
            pub const interface = &common.wp.image_description_creator_icc_v1.interface;
            pub const Error = common.wp.image_description_creator_icc_v1.Error;
            pub inline fn create(_client: *server.wl.Client, _version: u32, _id: u32) error{ResourceCreateFailed}!*ImageDescriptionCreatorIccV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ImageDescriptionCreatorIccV1, _version, _id));
            }
            pub inline fn destroy(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_icc_v1)).destroy();
            }
            pub inline fn fromLink(_link: *server.wl.list.Link) *ImageDescriptionCreatorIccV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub inline fn getLink(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_icc_v1)).getLink();
            }
            pub inline fn getClient(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_icc_v1)).getClient();
            }
            pub inline fn getId(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_icc_v1)).getId();
            }
            pub inline fn getVersion(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_icc_v1)).getVersion();
            }
            pub inline fn postNoMemory(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_icc_v1)).postNoMemory();
            }
            pub inline fn getUserData(_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1) ?*anyopaque {
            ...
            pub inline fn setHandler(
                _image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1,
                comptime T: type,
                handle_request: *const fn (_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_image_description_creator_icc_v1: *ImageDescriptionCreatorIccV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_creator_icc_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ImageDescriptionCreatorIccV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.c) void {
                            _handler(
                                @as(*ImageDescriptionCreatorIccV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            );
                        }
                    }._wrapper else null,
        ...
        pub const ImageDescriptionCreatorParamsV1 = opaque {
            ...
            pub const interface = &common.wp.image_description_creator_params_v1.interface;
            pub const Error = common.wp.image_description_creator_params_v1.Error;
            pub inline fn create(_client: *server.wl.Client, _version: u32, _id: u32) error{ResourceCreateFailed}!*ImageDescriptionCreatorParamsV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ImageDescriptionCreatorParamsV1, _version, _id));
            }
            pub inline fn destroy(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_params_v1)).destroy();
            }
            pub inline fn fromLink(_link: *server.wl.list.Link) *ImageDescriptionCreatorParamsV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub inline fn getLink(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_params_v1)).getLink();
            }
            pub inline fn getClient(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_params_v1)).getClient();
            }
            pub inline fn getId(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_params_v1)).getId();
            }
            pub inline fn getVersion(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_params_v1)).getVersion();
            }
            pub inline fn postNoMemory(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) void {
                return @as(*server.wl.Resource, @ptrCast(_image_description_creator_params_v1)).postNoMemory();
            }
            pub inline fn getUserData(_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1) ?*anyopaque {
            ...
            pub const Request = union(enum) {
                ...
                /// Compositors are recommended to detect this case and fail the image
                /// description gracefully, but it may as well result in color artifacts.
                set_mastering_display_primaries: struct {
                    r_x: i32,
                    r_y: i32,
                    g_x: i32,
                    g_y: i32,
                ...
                /// Compositors are recommended to detect this case and fail the image
                /// description gracefully, but it may as well result in color artifacts.
                set_mastering_luminance: struct {
                    min_lum: u32,
                    max_lum: u32,
                },
            ...
            pub inline fn setHandler(
                _image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1,
                comptime T: type,
                handle_request: *const fn (_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_image_description_creator_params_v1: *ImageDescriptionCreatorParamsV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_image_description_creator_params_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ImageDescriptionCreatorParamsV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.c) void {
                            _handler(
                                @as(*ImageDescriptionCreatorParamsV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            );
                        }
                    }._wrapper else null,
...
const common = struct {
    ...
    const wp = struct {
        const image_description_reference_v1 = struct {
            const interface: common.Interface = .{
        ...
        const color_manager_v1 = struct {
            const interface: common.Interface = .{
                ...
                .methods = &.{
                    ...
                    .{
                        ...
                        .signature = "no",
                        .types = &.{
                            &common.wp.color_management_output_v1.interface,
                            &common.wl.output.interface,
                        },
                    },
                    .{
                        ...
                        .signature = "no",
                        .types = &.{
                            &common.wp.color_management_surface_v1.interface,
                            &common.wl.surface.interface,
                        },
                    },
                    .{
                        ...
                        .signature = "no",
                        .types = &.{
                            &common.wp.color_management_surface_feedback_v1.interface,
                            &common.wl.surface.interface,
                        },
                    },
                    .{
                        ...
                        .signature = "n",
                        .types = &.{
                            &common.wp.image_description_creator_icc_v1.interface,
                        },
                    },
                    .{
                        ...
                        .signature = "n",
                        .types = &.{
                            &common.wp.image_description_creator_params_v1.interface,
                        },
                    },
                    .{
                        ...
                        .signature = "n",
                        .types = &.{
                            &common.wp.image_description_v1.interface,
                        },
                    },
                    .{
                        ...
                        .types = &.{
                            &common.wp.image_description_v1.interface,
                            &common.wp.image_description_reference_v1.interface,
                        },
                    },
                },
                .event_count = 5,
            ...
            const Error = enum(c_int) {
                pub const unsupported_feature_since_version = 1;
                pub const surface_exists_since_version = 1;
            ...
            const RenderIntent = enum(c_int) {
                pub const perceptual_since_version = 1;
                pub const relative_since_version = 1;
                pub const saturation_since_version = 1;
                pub const absolute_since_version = 1;
                pub const relative_bpc_since_version = 1;
                pub const absolute_no_adaptation_since_version = 2;
            ...
            const Feature = enum(c_int) {
                pub const icc_v2_v4_since_version = 1;
                pub const parametric_since_version = 1;
                pub const set_primaries_since_version = 1;
                pub const set_tf_power_since_version = 1;
                pub const set_luminances_since_version = 1;
                pub const set_mastering_display_primaries_since_version = 1;
                pub const extended_target_volume_since_version = 1;
                pub const windows_scrgb_since_version = 1;
            ...
            const Primaries = enum(c_int) {
                pub const srgb_since_version = 1;
                pub const pal_m_since_version = 1;
                pub const pal_since_version = 1;
                pub const ntsc_since_version = 1;
                pub const generic_film_since_version = 1;
                pub const bt2020_since_version = 1;
                pub const cie1931_xyz_since_version = 1;
                pub const dci_p3_since_version = 1;
                pub const display_p3_since_version = 1;
                pub const adobe_rgb_since_version = 1;
            ...
            const TransferFunction = enum(c_int) {
                pub const bt1886_since_version = 1;
                pub const gamma22_since_version = 1;
                pub const gamma28_since_version = 1;
                pub const st240_since_version = 1;
                pub const ext_linear_since_version = 1;
                pub const log_100_since_version = 1;
                pub const log_316_since_version = 1;
                pub const xvycc_since_version = 1;
                pub const srgb_since_version = 1;
                pub const ext_srgb_since_version = 1;
                pub const st2084_pq_since_version = 1;
                pub const st428_since_version = 1;
                pub const hlg_since_version = 1;
                pub const compound_power_2_4_since_version = 2;
        ...
        const color_management_output_v1 = struct {
            const interface: common.Interface = .{
        ...
        const image_description_v1 = struct {
            const interface: common.Interface = .{
                ...
                .methods = &.{
                    ...
                    .{
                        ...
                        .signature = "n",
                        .types = &.{
                            &common.wp.image_description_info_v1.interface,
                        },
                    },
                },
                .event_count = 3,
            ...
            const Error = enum(c_int) {
                pub const not_ready_since_version = 1;
                pub const no_information_since_version = 1;

                not_ready = 0,
                no_information = 1,
                _,
            };
            const Cause = enum(c_int) {
                pub const low_version_since_version = 1;
                pub const unsupported_since_version = 1;
                pub const operating_system_since_version = 1;
                pub const no_output_since_version = 1;
        ...
        const image_description_info_v1 = struct {
            const interface: common.Interface = .{
        ...
        const color_management_surface_v1 = struct {
            const interface: common.Interface = .{
            ...
            const Error = enum(c_int) {
                pub const render_intent_since_version = 1;
                pub const image_description_since_version = 1;
                pub const inert_since_version = 1;
        ...
        const color_management_surface_feedback_v1 = struct {
            const interface: common.Interface = .{
        ...
        const image_description_creator_icc_v1 = struct {
            const interface: common.Interface = .{
            ...
            const Error = enum(c_int) {
                pub const incomplete_set_since_version = 1;
                pub const already_set_since_version = 1;
                pub const bad_fd_since_version = 1;
                pub const bad_size_since_version = 1;
                pub const out_of_file_since_version = 1;
        ...
        const image_description_creator_params_v1 = struct {
            const interface: common.Interface = .{
            ...
            const Error = enum(c_int) {
                ...
                pub const already_set_since_version = 1;
                pub const unsupported_feature_since_version = 1;
                pub const invalid_tf_since_version = 1;
                pub const invalid_primaries_named_since_version = 1;
                pub const invalid_luminance_since_version = 1;
